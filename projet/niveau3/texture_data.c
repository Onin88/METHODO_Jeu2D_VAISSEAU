...
void clean_textures(textures_t *textures){
    ...
    // si le jeu est fini on clean la texture
}
...
void event_menu(SDL_Event *event,world_t *world){
    Uint8 *keystates;
...
void refresh_menu(SDL_Renderer *renderer, world_t *world, textures_t *textures){
    clear_renderer(renderer);
    textures->background = load_image("ressources/Menu.bmp", renderer);
...
void  init_textures(SDL_Renderer *renderer, textures_t *textures){
    ...
    //chargement de la texture arial ttf
...
void refresh_graphics(SDL_Renderer *renderer, world_t *world, textures_t *textures){
    ...
    //application des textures des ennemis
    ...
    //apply_text(renderer,30,30,15,15,"score:",textures->font);
